...
const PAYMENT_METHODS = ['Cash', 'Credit Card', 'Debit Card', 'Bank Transfer', 'Wallet', 'Other'];
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="absolute -bottom-20 -left-20 w-40 h-40 rounded-full bg-violet-500/10 blur-3xl pointer-events-none" />
